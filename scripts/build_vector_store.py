...
CORPUS_PATH = os.path.join(os.path.dirname(__file__), "../data/processed/science_corpus.json")
VECTOR_STORE_PATH = os.path.join(os.path.dirname(__file__), "../data/processed/vector_store")
COLLECTION_NAME = "science_corpus"
...
def build_vector_store(chunks: list[dict]) -> None:
    ...
    print(f"Persisted to: {os.path.abspath(VECTOR_STORE_PATH)}")
